...
public class AudioPlayer {
    ...
    public void setDataSource(String audioFile) {
        if (!TextUtils.equals(audioFile, mAudioFile)) {
            Log.d(TAG, "start play audio file" + audioFile);
            mAudioFile = audioFile;
        }
    }
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case WHAT_DECODE_FAILED: {
                    ...
                    Log.d(TAG, "convert() error: " + mAudioFile);
                }
                break;
    ...
    private void startInner() {
        ...
        mPlayer.setOnErrorListener(new MediaPlayer.OnErrorListener() {
            ...
            public boolean onError(MediaPlayer mp, int what, int extra) {
                Log.d(TAG, String.format("player:onOnError what:%d extra:%d", what, extra));
                endPlay();
                if (mListener != null) {
        ...
        try {
            ...
            Log.d(TAG, "player:start ok---->" + mAudioFile);
        } catch (Exception e) {
            e.printStackTrace();
            Log.d(TAG, "player:onOnError Exception\n" + e.toString());
            endPlay();
            if (mListener != null) {
