 ...
 * @Details: <功能描述>
 */
public class IdentifyCodeEditText extends AppCompatEditText {
    ...
    public IdentifyCodeEditText(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void setAttrs(AttributeSet attrs) {
        ...
        if (t != null) {
            ...
            textSize = t.getDimensionPixelSize(R.styleable.PwdEditText_textSize, (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP,28,getResources().getDisplayMetrics()));
            ...
            backColor = t.getColor(R.styleable.PwdEditText_backColor, Color.parseColor("#BCC9E1"));
            textColor = t.getColor(R.styleable.PwdEditText_textColor, Color.parseColor("#444444"));
            waitInputColor = t.getColor(R.styleable.PwdEditText_waitInputColor, Color.parseColor("#005CFF"));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < textLength; i++) {
            ...
            canvas.drawLine(i * Wide + spzceX,Wide - spzceY,i * Wide + Wide - spzceX,Wide - spzceY,backPaint);
